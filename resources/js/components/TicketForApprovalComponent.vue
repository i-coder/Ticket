            ...
            <div class="field is-grouped is-grouped-multiline">
                <div class="control">
                    <div class="tags has-addons">
                        ...
                        <span class="tag is-info">Задачи на согласование</span>
                    </div>
                </div>
            </div>
            <b-table
    ...
    export default {
        ...
        methods: {
            ...
            loadAsyncData: async function () {
                ...
                let todos = [];
                let allTotal = 0
                await axios.get(process.env.MIX_HTTP + window.location.hostname + '/you/tickets/not/agree',
                    {
                        params: {
                            data: params
                        }
            ...
            loadSubdivisionsName: async function () {
                ...
                try {
                    const resp = await axios.get(process.env.MIX_HTTP + window.location.hostname + '/getListSubdivisionsNameCountAuth');
